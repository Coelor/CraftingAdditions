...
public class BlockAnvilNew : Block
{
    WorldInteraction[] interactions;
                ...
                return new WorldInteraction[] {
                    new WorldInteraction()
                    {
                        ...
                        GetMatchingStacks = (wi, bs, es) => {
                            BEAnvilNew bea = api.World.BlockAccessor.GetBlockEntity(bs.Position) as BEAnvilNew;
        ...
        public override void OnDecalTesselation(IWorldAccessor world, MeshData decalMesh, BlockPos pos)
        {
            ...
            BEAnvilNew bect = world.BlockAccessor.GetBlockEntity(pos) as BEAnvilNew;
            if (bect != null)
            {
        ...
        {
            BEAnvilNew bea = blockAccessor.GetBlockEntity(pos) as BEAnvilNew;
            if (bea != null)
            {
        ...
        {
            BEAnvilNew bea = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BEAnvilNew;
            if (bea != null)
            {
        ...
        public override bool DoPlaceBlock(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel, ItemStack byItemStack)
        {
            ...
            if (val)
            {
                BEAnvilNew bect = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BEAnvilNew;
                if (bect != null)
                {
