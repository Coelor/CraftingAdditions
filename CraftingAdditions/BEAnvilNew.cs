...
{
  public class BEAnvilNew : BlockEntity
  { 
      ...
      { 
        ...
        AnvilNewWorkItemRenderer workitemRenderer;
        public int rotation;
       ...
       // }
        ...
        public override void Initialize(ICoreAPI api)
        {
            ...
            if (api is ICoreClientAPI)
            {
                ...
                capi.Event.RegisterRenderer(workitemRenderer = new AnvilNewWorkItemRenderer(this, Pos, capi), EnumRenderStage.Opaque);
